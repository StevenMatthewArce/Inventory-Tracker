...
>>>>>>> finishedGoodsRecipes
     ...
     */    static create(t, n, e) {
<<<<<<< HEAD
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.D(t, n, e) : new Mt(t, n, e) : "array-contains" /* ARRAY_CONTAINS */ === n ? new zt(t, e) : "in" /* IN */ === n ? new Wt(t, e) : "not-in" /* NOT_IN */ === n ? new Gt(t, e) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Ht(t, e) : new jt(t, n, e);
    }
    static D(t, n, e) {
...
<<<<<<< HEAD
/** Filter that matches on key fields within an array. */ class kt extends jt {
    constructor(t, n) {
...
<<<<<<< HEAD
/** Filter that matches on key fields not present within an array. */ class Bt extends jt {
    constructor(t, n) {
...
/** A Filter that implements the array-contains operator. */ class zt extends jt {
=======
function Mt(t, n) {
    var e;
...
/** A Filter that implements the IN operator. */ class Wt extends jt {
=======
...
/** A Filter that implements the not-in operator. */ class Gt extends jt {
=======
        const n = t.field(this.field);
...
/** A Filter that implements the array-contains-any operator. */ class Ht extends jt {
=======
...
<<<<<<< HEAD
                ...
                new M(n, t.sessionIndex || "0", t.iamToken || null);
=======
...
=======
 */ function se(t) {
    return t = J(t, Xn), n(t.app, "firestore/lite"), t._delete();
>>>>>>> finishedGoodsRecipes
}
 ...
 */ class ie extends se {
    /** @hideconstructor */
    constructor(t, n, e) {
        super(t, n, new Xt(e)), this.firestore = t, this._path = e, this.type = "collection";
=======
 */ class ue extends oe {
    /** @hideconstructor */
    constructor(t, n, e) {
...
<<<<<<< HEAD
    ...
    at(t) {
        return je(t, this.settings.methodName, this.settings.ht || !1, this.path, this.settings.lt);
=======
    get ot() {
...
/** Parse update data from a list of field/value arguments. */ function $e(t, n, e, r, s, i) {
    ...
    for (let t = u.length - 1; t >= 0; --t) if (!Me(h, u[t])) {
=======
...
<<<<<<< HEAD
 */ function Ue(t, n, e) {
    if (n.search(Le) >= 0) throw je(`Invalid field path (${n}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, e);
    try {
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Me(t, n) {
=======
...
export { de as Bytes, ue as CollectionReference, ie as DocumentReference, Qe as DocumentSnapshot, we as FieldPath, pe as FieldValue, Xn as FirebaseFirestore, x as FirestoreError, ye as GeoPoint, oe as Query, He as QueryConstraint, We as QueryDocumentSnapshot, ze as QuerySnapshot, _t as Timestamp, qs as Transaction, Rs as WriteBatch, vs as addDoc, As as arrayRemove, Ts as arrayUnion, ce as collection, ae as collectionGroup, bs as deleteDoc, Es as deleteField, he as doc, me as documentId, as as endAt, cs as endBefore, ps as getDoc, ys as getDocs, ne as getFirestore, Ps as increment, te as initializeFirestore, es as limit, ss as limitToLast, ts as orderBy, Ke as query, fe as queryEqual, le as refEqual, Os as runTransaction, Is as serverTimestamp, _s as setDoc, a as setLogLevel, Ge as snapshotEqual, os as startAfter, is as startAt, se as terminate, gs as updateDoc, ee as useFirestoreEmulator, Ze as where, Ns as writeBatch };
>>>>>>> finishedGoodsRecipes
