...
function m(t, ...n) {
    if (l.logLevel <= u.WARN) {
        const e = n.map(p);
        l.warn(`Firestore (8.3.3): ${t}`, ...e);
=======
function l(t, ...n) {
    if (a.logLevel <= o.DEBUG) {
        const e = n.map(w);
        a.debug(`Firestore (8.3.1): ${t}`, ...e);
    }
}
...
=======
 */ const _ = "ok", g = "cancelled", b = "unknown", v = "invalid-argument", E = "deadline-exceeded", I = "not-found", T = "already-exists", A = "permission-denied", P = "unauthenticated", R = "resource-exhausted", V = "failed-precondition", N = "aborted", $ = "out-of-range", D = "unimplemented", F = "internal", S = "unavailable", x = "data-loss";
>>>>>>> finishedGoodsRecipes
...
=======
            if (e.indexOf("//") >= 0) throw new q(v, `Invalid segment (${e}). Paths must not contain // in them.`);
>>>>>>> finishedGoodsRecipes
...
=======
        let e = "", s = 0;
        const r = () => {
            if (0 === e.length) throw new q(v, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
>>>>>>> finishedGoodsRecipes
            n.push(e), e = "";
        };
        let i = !1;
...
<<<<<<< HEAD
    ...
    static emptyPath() {
        return new H([]);
=======
                if (s + 1 === t.length) throw new q(v, "Path has trailing escape character: " + t);
                const n = t[s + 1];
                if ("\\" !== n && "." !== n && "`" !== n) throw new q(v, "Path has invalid escape sequence: " + t);
                e += n, s += 2;
            } else "`" === n ? (i = !i, s++) : "." !== n || i ? (e += n, s++) : (r(), s++);
        }
        if (r(), i) throw new q(v, "Unterminated ` in path: " + t);
        return new z(n);
    }
    static emptyPath() {
        return new z([]);
...
=======
 */ function Y(t, n, e) {
    if (!e) throw new q(v, `Function ${t}() cannot be called with an empty ${n}.`);
>>>>>>> finishedGoodsRecipes
}
...
=======
function H(t) {
    if (!G.isDocumentKey(t)) throw new q(v, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
>>>>>>> finishedGoodsRecipes
}
...
=======
 */ function K(t) {
    if (G.isDocumentKey(t)) throw new q(v, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
>>>>>>> finishedGoodsRecipes
}
...
=======
        if (n.name === t.constructor.name) throw new q(v, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const e = J(t);
            throw new q(v, `Expected type '${n.name}', but it was: ${e}`);
>>>>>>> finishedGoodsRecipes
        }
    }
    return t;
...
=======
function X(t, n) {
    if (n <= 0) throw new q(v, `Function ${t}() requires a positive number, but it was: ${n}.`);
>>>>>>> finishedGoodsRecipes
}
...
=======
function it(t) {
    if (void 0 === t) return f("RPC_ERROR", "HTTP error has no status"), b;
>>>>>>> finishedGoodsRecipes
...
=======
      ...
      default:
        return t >= 200 && t < 300 ? _ : t >= 400 && t < 500 ? V : t >= 500 && t < 600 ? F : b;
>>>>>>> finishedGoodsRecipes
    }
}
...
=======
    ...
    p(t, n, e, s) {
        ...
        const i = {};
        return this.v(i, s), this.I(t, r, i, e).then((t => (l("RestConnection", "Received: ", t), 
>>>>>>> finishedGoodsRecipes
        t)), (n => {
...
class bt {
     ...
     */
    constructor(t, n) {
        if (this.seconds = t, this.nanoseconds = n, n < 0) throw new q(v, "Timestamp nanoseconds out of range: " + n);
        if (n >= 1e9) throw new q(v, "Timestamp nanoseconds out of range: " + n);
        if (t < -62135596800) throw new q(v, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new q(v, "Timestamp seconds out of range: " + t);
    }
    /**
     * Creates a new timestamp with the current date, with millisecond precision.
     *
...
/** Extracts the backend's type order for the provided value. */ function Tt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? vt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : m();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function At(t, n) {
    const e = Tt(t);
    if (e !== Tt(n)) return !1;
>>>>>>> finishedGoodsRecipes
    switch (e) {
...
=======
            return gt(t.bytesValue).isEqual(gt(n.bytesValue));
>>>>>>> finishedGoodsRecipes
        }(t, n);
...
=======
            return _t(t.geoPointValue.latitude) === _t(n.geoPointValue.latitude) && _t(t.geoPointValue.longitude) === _t(n.geoPointValue.longitude);
>>>>>>> finishedGoodsRecipes
        }(t, n);
...
=======
            if ("integerValue" in t && "integerValue" in n) return _t(t.integerValue) === _t(n.integerValue);
            if ("doubleValue" in t && "doubleValue" in n) {
                const e = _t(t.doubleValue), s = _t(n.doubleValue);
...
=======
        return lt(t.arrayValue.values || [], n.arrayValue.values || [], At);

      case 10 /* ObjectValue */ :
        return function(t, n) {
            const e = t.mapValue.fields || {}, s = n.mapValue.fields || {};
            if (ft(e) !== ft(s)) return !1;
            for (const t in e) if (e.hasOwnProperty(t) && (void 0 === s[t] || !At(e[t], s[t]))) return !1;
>>>>>>> finishedGoodsRecipes
            return !0;
        }
...
function Pt(t, n) {
    return void 0 !== (t.values || []).find((t => At(t, n)));
}
...
=======
            const e = _t(t.integerValue || t.doubleValue), s = _t(n.integerValue || n.doubleValue);
...
=======
            const e = ht(_t(t.latitude), _t(n.latitude));
            if (0 !== e) return e;
            return ht(_t(t.longitude), _t(n.longitude));
>>>>>>> finishedGoodsRecipes
...
function Vt(t, n) {
    ...
    const e = yt(t), s = yt(n), r = ht(e.seconds, s.seconds);
 ...
 */ class qt extends xt {
    ...
    isEqual(t) {
        return t instanceof qt && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.hasLocalMutations === t.hasLocalMutations && this.hasCommittedMutations === t.hasCommittedMutations && this.objectValue.isEqual(t.objectValue);
    }
    toString() {
 ...
 */ function Mt(t, n = null, e = [], r = [], s = null, i = null, o = null) {
    return new jt(t, n, e, r, s, i, o);
=======
 */ function Lt(t, n = null, e = [], s = [], r = null, i = null, o = null) {
    return new Ct(t, n, e, s, r, i, o);
>>>>>>> finishedGoodsRecipes
}
...
=======
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.N(t, n, e) : new jt(t, n, e) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Qt(t, e) : "in" /* IN */ === n ? new Wt(t, e) : "not-in" /* NOT_IN */ === n ? new zt(t, e) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Gt(t, e) : new Ut(t, n, e);
    }
    static N(t, n, e) {
        return "in" /* IN */ === n ? new Mt(t, e) : new Bt(t, e);
>>>>>>> finishedGoodsRecipes
    }
    matches(t) {
...
=======
                return "!=" /* NOT_EQUAL */ === this.op ? null !== n && this.$(Rt(n, this.value)) : null !== n && Tt(this.value) === Tt(n) && this.$(Rt(n, this.value));
>>>>>>> finishedGoodsRecipes
...
/** Filter that matches on key fields not present within an array. */ class Bt extends Ut {
    constructor(t, n) {
<<<<<<< HEAD
...
=======
        ...
        return $t(n) && Pt(n.arrayValue, this.value);
>>>>>>> finishedGoodsRecipes
    }
}

/** A Filter that implements the IN operator. */ class Wt extends Ut {
    constructor(t, n) {
        super(t, "in" /* IN */ , n);
    }
    matches(t) {
...
=======
        const n = t.field(this.field);
        return null !== n && Pt(this.value.arrayValue, n);
    }
}

/** A Filter that implements the not-in operator. */ class zt extends Ut {
>>>>>>> finishedGoodsRecipes
    constructor(t, n) {
...
=======
        const n = t.field(this.field);
        return !(!$t(n) || !n.arrayValue.values) && n.arrayValue.values.some((t => Pt(this.value.arrayValue, t)));
>>>>>>> finishedGoodsRecipes
    }
}
...
function Jt(t, n) {
    ...
    if (t.before !== n.before || t.position.length !== n.position.length) return !1;
    for (let e = 0; e < t.position.length; e++) {
        if (!At(t.position[e], n.position[e])) return !1;
    }
    return !0;
}
 ...
 */ function sn(t) {
    ...
    if (null === n.F) {
        ...
        t.isKeyField() || n.F.push(new Ht(t)), n.F.push(new Ht(z.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function rn(t) {
    const n = y(t);
    if (!n.S) if ("F" /* First */ === n.limitType) n.S = Lt(n.path, n.collectionGroup, sn(n), n.filters, n.limit, n.startAt, n.endAt); else {
        // Flip the orderBy directions since we want the last results
        const t = [];
        for (const e of sn(n)) {
            const n = "desc" /* DESCENDING */ === e.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            t.push(new Ht(e.field, n));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                const e = n.endAt ? new Yt(n.endAt.position, !n.endAt.before) : null, s = n.startAt ? new Yt(n.startAt.position, !n.startAt.before) : null;
        // Now return as a LimitType.First query.
        n.S = Lt(n.path, n.collectionGroup, t, n.filters, n.limit, e, s);
    }
    return n.S;
}
 ...
 */ function cn(t) {
    const n = g(t);
    if (!n.q) if ("F" /* First */ === n.limitType) n.q = Mt(n.path, n.collectionGroup, un(n), n.filters, n.limit, n.startAt, n.endAt); else {
        // Flip the orderBy directions since we want the last results
        const t = [];
        for (const e of un(n)) {
            const n = "desc" /* DESCENDING */ === e.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
        ...
        // Now return as a LimitType.First query.
        n.q = Mt(n.path, n.collectionGroup, t, n.filters, n.limit, e, r);
    }
    return n.q;
}
 ...
 */ class hn {
    ...
    /** Returns an ObjectValue with all mutations applied. */    L() {
        const t = this.U(z.emptyPath(), this.O);
        return null != t ? new an(t) : this.q;
    }
    /**
     * Applies any overlays from `currentOverlays` that exist at `currentPath`
     * and returns the merged data at `currentPath` (or null if there were no
     ...
     */    U(t, n) {
        let e = !1;
        const s = this.q.field(t), r = St(s) ? // If there is already data at the current path, base our
...
=======
/** Transforms an array value via a union operation. */ class wn extends fn {
>>>>>>> finishedGoodsRecipes
    constructor(t) {
...
=======
/** Transforms an array value via a remove operation. */ class mn extends fn {
>>>>>>> finishedGoodsRecipes
    constructor(t) {
        super(), this.elements = t;
    }
...
/** A mutation that deletes the document at the given key. */ class En extends gn {
>>>>>>> finishedGoodsRecipes
    constructor(t, n) {
...
function Nn(t, n) {
    return Rn(t, n.toTimestamp());
}

function $n(t) {
    return p(!!t), un.fromTimestamp(function(t) {
        const n = yt(t);
        return new bt(n.seconds, n.nanos);
>>>>>>> finishedGoodsRecipes
    }(t));
...
=======
    ...
    if (e.get(1) !== t.databaseId.projectId) throw new q(v, "Tried to deserialize key from different project: " + e.get(1) + " vs " + t.databaseId.projectId);
    if (e.get(3) !== t.databaseId.database) throw new q(v, "Tried to deserialize key from different database: " + e.get(3) + " vs " + t.databaseId.database);
    return new G((p((s = e).length > 4 && "documents" === s.get(4)), s.popFirst(5)));
    var s;
    /** Creates a Document proto from key and fields (but no create/update time) */}
...
=======
        ...
        const e = Sn(t, n.found.name), s = $n(n.found.updateTime), r = new an({
>>>>>>> finishedGoodsRecipes
            mapValue: {
...
=======
    } ]) : (e.parent = xn(t, s.popLast()), e.structuredQuery.from = [ {
...
<<<<<<< HEAD
     */ , s = 6e4) {
        this.U = t, this.timerId = n, this.j = e, this.M = r, this.k = s, this.B = 0, this.W = null, 
...
<<<<<<< HEAD
        ...
        // bounds.
        this.B *= this.M, this.B < this.j && (this.B = this.j), this.B > this.k && (this.B = this.k);
    }
    J() {
...
=======
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && l("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.H} ms, delay with jitter: ${n} ms, last attempt: ${e} ms ago)`), 
...
class Yn extends class {} {
    ...
    rt() {
        if (this.st) throw new q(V, "The client has already been terminated.");
    }
...
async function Yn(t, n) {
    ...
    i.forEach((t => {
        const n = On(e.C, t);
=======
    const e = y(t), s = qn(e.M) + "/documents", r = {
        writes: n.map((t => Ln(e.M, t)))
    };
...
async function Jn(t, n) {
    const e = y(t), s = Un(e.M, rn(n));
    return (await e.T("RunQuery", s.parent, {
        structuredQuery: s.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, n, e) {
        const s = Sn(t, n.name), r = $n(n.updateTime), i = new an({
            mapValue: {
                fields: n.fields
            }
        });
...
function Xn(t) {
    ...
    if (!Zn.has(t)) {
        ...
        }((n = t._databaseId, e = t._persistenceKey, s = t._freezeSettings(), new M(n, e, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling))), i = zn(t._databaseId), o = function(t, n, e) {
            return new Yn(t, n, e);
        }(t._credentials, r, i);
        Zn.set(t, o);
    }
...
=======
            if (void 0 !== t.ssl) throw new q(v, "Can't provide ssl option if host option is not set");
>>>>>>> finishedGoodsRecipes
...
=======
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new q(v, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        function(t, n, e, s) {
            if (!0 === n && !0 === s) throw new q(v, `${t} and ${e} cannot be used together.`);
>>>>>>> finishedGoodsRecipes
 ...
 */ class ne {
    /** @hideconstructor */
    constructor(t, n) {
        this._persistenceKey = "(lite)", this._settings = new te({}), this._settingsFrozen = !1, 
        t instanceof B ? (this._databaseId = t, this._credentials = new C) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new q(v, '"projectId" not provided in firebase.initializeApp.');
...
=======
        ...
        this._settings = new te(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new C;
>>>>>>> finishedGoodsRecipes
            switch (t.type) {
              case "gapi":
...
=======
                throw new q(v, "makeCredentialsProvider failed due to invalid credential type");
>>>>>>> finishedGoodsRecipes
            }
        }(t.credentials));
    }
...
=======
            const n = Zn.get(t);
            n && (l("ComponentProvider", "Removing Datastore"), Zn.delete(t), n.terminate());
>>>>>>> finishedGoodsRecipes
...
=======
function ee(n, e) {
    const s = t(n, "firestore/lite");
    if (s.isInitialized()) throw new q(V, "Firestore can only be initialized once per app.");
    return s.initialize({
>>>>>>> finishedGoodsRecipes
        options: e
    });
...
=======
 */ function ie(t) {
    return t = Z(t, ne), n(t.app, "firestore/lite"), t._delete();
>>>>>>> finishedGoodsRecipes
}
...
=======
        return new ae(this.firestore, this._converter, this._key.path.popLast());
    }
    withConverter(t) {
 ...
 */ class ue extends oe {
    /** @hideconstructor */
    constructor(t, n, e) {
        super(t, n, new nn(e)), this.firestore = t, this._path = e, this.type = "collection";
=======
 */ class ae extends ce {
    /** @hideconstructor */
    constructor(t, n, e) {
...
function he(t, n, ...e) {
    if (t instanceof oe && (t = t._delegate), Y("collection", "path", n), t instanceof ne) {
        const s = Q.fromString(n, ...e);
        return K(s), new ae(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof ue || t instanceof ae)) throw new q(v, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = Q.fromString(t.path, ...e).child(Q.fromString(n));
        return K(s), new ae(t.firestore, 
        /* converter= */ null, s);
>>>>>>> finishedGoodsRecipes
    }
}
...
=======
 */ function le(t, n) {
    if (t = Z(t, ne), Y("collectionGroup", "collection id", n), n.indexOf("/") >= 0) throw new q(v, `Invalid collection ID '${n}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new ce(t, 
>>>>>>> finishedGoodsRecipes
    /* converter= */ null, 
    /**
...
function fe(t, n, ...e) {
    if (t instanceof oe && (t = t._delegate), 
    // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
    1 === arguments.length && (n = at.R()), Y("doc", "path", n), t instanceof ne) {
        const s = Q.fromString(n, ...e);
        return H(s), new ue(t, 
    ...
    {
        if (!(t instanceof ue || t instanceof ae)) throw new q(v, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(Q.fromString(n, ...e));
        return H(s), new ue(t.firestore, t instanceof ae ? t._converter : null, new G(s));
>>>>>>> finishedGoodsRecipes
    }
}
...
=======
 */ function de(t, n) {
    return t instanceof oe && (t = t._delegate), n instanceof oe && (n = n._delegate), 
    (t instanceof ue || t instanceof ae) && (n instanceof ue || n instanceof ae) && (t.firestore === n.firestore && t.path === n.path && t._converter === n._converter);
>>>>>>> finishedGoodsRecipes
}
 ...
 */ function we(t, n) {
    return t instanceof oe && (t = t._delegate), n instanceof oe && (n = n._delegate), 
    t instanceof ce && n instanceof ce && (t.firestore === n.firestore && on(t._query, n._query) && t._converter === n._converter);
>>>>>>> finishedGoodsRecipes
}
...
=======
            return new me(mt.fromBase64String(t));
        } catch (t) {
            throw new q(v, "Failed to construct data from Base64 string: " + t);
>>>>>>> finishedGoodsRecipes
        }
    }
    /**
...
=======
        return new me(mt.fromUint8Array(t));
>>>>>>> finishedGoodsRecipes
    }
    /**
 ...
 */ class pe {
     ...
     */
    constructor(...t) {
        for (let n = 0; n < t.length; ++n) if (0 === t[n].length) throw new q(v, "Invalid field name at argument $(i + 1). Field names must not be empty.");
...
=======
        if (!isFinite(t) || t < -90 || t > 90) throw new q(v, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(n) || n < -180 || n > 180) throw new q(v, "Longitude must be a number between -180 and 180, but was: " + n);
>>>>>>> finishedGoodsRecipes
...
=======
        return null !== this.fieldMask ? new vn(t, this.data, this.fieldMask, n, this.fieldTransforms) : new bn(t, this.data, n, this.fieldTransforms);
    }
}
...
=======
    ...
    /** Returns a new context with the specified settings overwritten. */    ut(t) {
        return new Te(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.M, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ct(t) {
        var n;
    ...
    dt(t) {
        return Qe(t, this.settings.methodName, this.settings.wt || !1, this.path, this.settings.yt);
>>>>>>> finishedGoodsRecipes
    }
...
=======
    ...
    ht(t) {
        ...
        if (Ie(this.ot) && be.test(t)) throw this.dt('Document fields cannot begin and end with "__"');
>>>>>>> finishedGoodsRecipes
    }
}
 ...
 */ class Ae {
    constructor(t, n, e) {
        this.databaseId = t, this.ignoreUndefinedProperties = n, this.M = e || zn(t);
    }
...
/** Parse document data from a set() call. */ function Re(t, n, e, s, r, i = {}) {
    ...
    je("Data must be an object, but it was:", o, s);
    const u = Le(s, o);
    let c, a;
    if (i.merge) c = new cn(o.fieldMask), a = o.fieldTransforms; else if (i.mergeFields) {
        const t = [];
        for (const s of i.mergeFields) {
            const r = Me(n, s, e);
            if (!o.contains(r)) throw new q(v, `Field '${r}' is specified in your field mask but missing from your input data.`);
            We(t, r) || t.push(r);
        }
        c = new cn(t), a = o.fieldTransforms.filter((t => c.covers(t.field)));
    } else c = null, a = o.fieldTransforms;
    return new ve(new an(u), c, a);
}
...
class De extends _e {
    ...
    _toFieldTransform(t) {
        const n = Ne(this, t, 
        /*array=*/ !0), e = this.gt.map((t => Ce(t, n))), s = new wn(e);
...
class Fe extends _e {
    ...
    _toFieldTransform(t) {
        const n = Ne(this, t, 
        /*array=*/ !0), e = this.gt.map((t => Ce(t, n))), s = new mn(e);
        return new yn(t.path, s);
>>>>>>> finishedGoodsRecipes
    }
    isEqual(t) {
...
class Se extends _e {
    ...
    _toFieldTransform(t) {
        const n = new pn(t.M, ln(t.M, this.bt));
...
=======
/** Parse update data from an update() call. */ function xe(t, n, e, s) {
    const r = t._t(1 /* Update */ , n, e);
    je("Data must be an object, but it was:", r, s);
    const i = [], o = new hn;
    dt(s, ((t, s) => {
        const u = ke(n, t, e);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                s instanceof oe && (s = s._delegate);
        const c = r.lt(u);
        if (s instanceof Ve) 
        // Add it to the field mask, but don't add anything to updateData.
        i.push(u); else {
    ...
    const u = new cn(i);
    return new Ee(o.L(), u, r.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function qe(t, n, e, s, r, i) {
    const o = t._t(1 /* Update */ , n, e), u = [ Me(n, s, e) ], c = [ r ];
    if (i.length % 2 != 0) throw new q(v, `Function ${n}() needs to be called with an even number of arguments that alternate between field names and values.`);
...
=======
    ...
    const l = new cn(a);
    return new Ee(h.L(), l, o.fieldTransforms);
>>>>>>> finishedGoodsRecipes
}
...
=======
 */ function Oe(t, n, e, s = !1) {
    return Ce(e, t._t(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , n));
>>>>>>> finishedGoodsRecipes
}
 ...
 */ function Ce(t, n) {
    ...
    // Unwrap the API type from the Compat SDK. This will return the API type
    // from firestore-exp.
    t instanceof oe && (t = t._delegate), Ue(t)) return je("Unsupported field value:", n, t), 
    Le(t, n);
    if (t instanceof _e) 
>>>>>>> finishedGoodsRecipes
...
=======
        if (!Ie(n.ot)) throw n.dt(`${t._methodName}() can only be used with update() and set()`);
...
=======
        t instanceof oe && (t = t._delegate);
        if (null === t) return {
            nullValue: "NULL_VALUE"
        };
        if ("number" == typeof t) return ln(n.M, t);
>>>>>>> finishedGoodsRecipes
...
=======
            bytesValue: Vn(n.M, t._byteString)
        };
        if (t instanceof ue) {
...
=======
        throw n.dt(`Unsupported field value: ${J(t)}`);
>>>>>>> finishedGoodsRecipes
    }
    /**
...
=======
function Ue(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof bt || t instanceof ge || t instanceof me || t instanceof ue || t instanceof _e);
}
 ...
 */ function Me(t, n, e) {
    ...
    // If required, replace the FieldPath Compat class with with the firestore-exp
    // FieldPath.
    n instanceof oe && (n = n._delegate), n instanceof pe) return n._internalPath;
    if ("string" == typeof n) return ke(t, n);
...
<<<<<<< HEAD
 */ function Me(t, n, e) {
    if (n.search(je) >= 0) throw ke(`Invalid field path (${n}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, e);
    try {
 ...
 */ function He(t, n) {
    return t instanceof oe && (t = t._delegate), n instanceof oe && (n = n._delegate), 
    t instanceof ze && n instanceof ze ? t._firestore === n._firestore && t._key.isEqual(n._key) && (null === t._document ? null === n._document : t._document.isEqual(n._document)) && t._converter === n._converter : t instanceof Ye && n instanceof Ye && (we(t.query, n.query) && lt(t.docs, n.docs, He));
>>>>>>> finishedGoodsRecipes
}
...
<<<<<<< HEAD
 */ function He(t, n) {
    return "string" == typeof n ? Me(t, n) : n instanceof de ? n._internalPath : n._delegate._internalPath;
=======
 */ function Ke(t, n) {
    return "string" == typeof n ? ke(t, n) : n instanceof oe ? n._delegate._internalPath : n._internalPath;
>>>>>>> finishedGoodsRecipes
}
...
class Xe extends Je {
    ...
    _apply(t) {
        const n = Pe(t.firestore), e = function(t, n, e, s, r, i, o) {
            let u;
            if (r.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === i || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === i) throw new q(v, `Invalid Query. You can't perform '${i}' queries on FieldPath.documentId().`);
>>>>>>> finishedGoodsRecipes
...
=======
                    for (const e of o) n.push(ds(s, t, e));
>>>>>>> finishedGoodsRecipes
                    u = {
                        arrayValue: {
                            values: n
...
=======
            ...
            u = Oe(e, n, o, 
            /* allowArrays= */ "in" /* IN */ === i || "not-in" /* NOT_IN */ === i);
            const c = Ut.create(r, i, u);
            return function(t, n) {
                if (n.D()) {
                    const e = nn(t);
                    if (null !== e && !e.isEqual(n.field)) throw new q(v, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${e.toString()}' and '${n.field.toString()}'`);
                    const s = tn(t);
...
=======
                throw e === n.op ? new q(v, `Invalid query. You cannot use more than one '${n.op.toString()}' filter.`) : new q(v, `Invalid query. You cannot use '${n.op.toString()}' filters with '${e.toString()}' filters.`);
            }(t, c), c;
        }(t._query, "where", n, t.firestore._databaseId, this.vt, this.Et, this.It);
        return new ce(t.firestore, t._converter, function(t, n) {
            const e = t.filters.concat([ n ]);
...
class ns extends Je {
    ...
    _apply(t) {
        const n = function(t, n, e) {
            if (null !== t.startAt) throw new q(v, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new q(v, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const s = new Ht(n, e);
>>>>>>> finishedGoodsRecipes
            return function(t, n) {
                if (null === tn(t)) {
...
class ss extends Je {
    ...
    _apply(t) {
        return new ce(t.firestore, t._converter, function(t, n, e) {
...
=======
 */ function rs(t) {
    return X("limit", t), new ss("limit", t, "F" /* First */);
>>>>>>> finishedGoodsRecipes
}
...
=======
 */ function is(t) {
    return X("limitToLast", t), new ss("limitToLast", t, "L" /* Last */);
}
...
class os extends Je {
    ...
    _apply(t) {
        const n = fs(t, this.type, this.Rt, this.Vt);
        return new ce(t.firestore, t._converter, function(t, n) {
...
=======
function hs(...t) {
    return new as("endBefore", t, /*before=*/ !0);
}

function ls(...t) {
    return new as("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function fs(t, n, e, s) {
    if (e[0] instanceof oe && (e[0] = e[0]._delegate), e[0] instanceof ze) return function(t, n, e, s, r) {
        if (!s) throw new q(I, `Can't use a DocumentSnapshot that doesn't exist for ${e}().`);
>>>>>>> finishedGoodsRecipes
        const i = [];
 ...
 */ (t._query, t.firestore._databaseId, n, e[0]._document, r);
    {
        ...
        return function(t, n, e, r, s, i) {
            ...
            return new Jt(u, i);
=======
                for (const e of sn(t)) if (e.field.isKeyField()) i.push(Nt(n, s.key)); else {
            const t = s.field(e.field);
            if (vt(t)) throw new q(v, 'Invalid query. You are trying to start or end a query using a document for which the field "' + e.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = e.field.canonicalString();
                throw new q(v, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            i.push(t);
        }
        return new Yt(i, r);
 ...
 */ (t._query, t.firestore._databaseId, n, e[0]._document, s);
    {
        ...
        return function(t, n, e, s, r, i) {
            // Use explicit order by's because it has to match the query the user made
            const o = t.explicitOrderBy;
            if (r.length > o.length) throw new q(v, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const u = [];
            for (let i = 0; i < r.length; i++) {
                const c = r[i];
                if (o[i].field.isKeyField()) {
                    if ("string" != typeof c) throw new q(v, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof c}`);
                    if (!en(t) && -1 !== c.indexOf("/")) throw new q(v, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${c}' contains a slash.`);
                    const e = t.path.child(Q.fromString(c));
                    if (!G.isDocumentKey(e)) throw new q(v, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${e}' is not because it contains an odd number of segments.`);
                    const r = new G(e);
                    u.push(Nt(n, r));
                } else {
                    const t = Oe(e, s, c);
...
function ds(t, n, e) {
    if (e instanceof oe && (e = e._delegate), "string" == typeof e) {
        if ("" === e) throw new q(v, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!en(n) && -1 !== e.indexOf("/")) throw new q(v, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);
        const s = n.path.child(Q.fromString(e));
        if (!G.isDocumentKey(s)) throw new q(v, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return Nt(t, new G(s));
    }
    if (e instanceof ue) return Nt(t, e._key);
    throw new q(v, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${J(e)}.`);
>>>>>>> finishedGoodsRecipes
}
...
=======
 */ function ws(t, n) {
    if (!Array.isArray(t) || 0 === t.length) throw new q(v, `Invalid Query. A non-empty array is required for '${n.toString()}' filters.`);
    if (t.length > 10) throw new q(v, `Invalid Query. '${n.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function ms(t, n, e) {
    if (!e.isEqual(n)) throw new q(v, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${n.toString()}' and so you must also use '${n.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${e.toString()}' instead.`);
>>>>>>> finishedGoodsRecipes
}
...
=======
    ...
    convertGeoPoint(t) {
        return new ge(_t(t.latitude), _t(t.longitude));
>>>>>>> finishedGoodsRecipes
    }
    convertArray(t, n) {
...
=======
    ...
    convertDocumentKey(t, n) {
        ...
        p(Wn(e));
        const s = new B(e.get(1), e.get(3)), r = new G(e.popFirst(5));
        return s.isEqual(n) || 
>>>>>>> finishedGoodsRecipes
...
=======
 */ function _s(t) {
    const n = Xn((t = Z(t, ue)).firestore), e = new ys(t.firestore);
    return Kn(n, [ t._key ]).then((n => {
        p(1 === n.length);
        const s = n[0];
        return new ze(t.firestore, e, t._key, s instanceof qt ? s : null, t._converter);
>>>>>>> finishedGoodsRecipes
    }));
}
 ...
 */ function gs(t) {
    !function(t) {
        if (Xt(t) && 0 === t.explicitOrderBy.length) throw new q(D, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = Z(t, ce))._query);
    const n = Xn(t.firestore), e = new ys(t.firestore);
    return Jn(n, t._query).then((n => {
        const s = n.map((n => new Ge(t.firestore, e, n.key, n, t._converter)));
        return Xt(t._query) && 
        // Limit to last queries reverse the orderBy constraint that was
        // specified by the user. As such, we need to reverse the order of the
        // results to return the documents in the expected order.
        s.reverse(), new Ye(t, s);
    }));
}

function bs(t, n, e) {
    const s = ps((t = Z(t, ue))._converter, n, e), r = Re(Pe(t.firestore), "setDoc", t._key, s, null !== t._converter, e);
    return Hn(Xn(t.firestore), [ r.toMutation(t._key, _n.none()) ]);
}

function vs(t, n, e, ...s) {
    const r = Pe((t = Z(t, ue)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    n instanceof oe && (n = n._delegate), i = "string" == typeof n || n instanceof pe ? qe(r, "updateDoc", t._key, n, e, s) : xe(r, "updateDoc", t._key, n);
    return Hn(Xn(t.firestore), [ i.toMutation(t._key, _n.exists(!0)) ]);
>>>>>>> finishedGoodsRecipes
}
...
=======
 */ function Es(t) {
    return Hn(Xn((t = Z(t, ue)).firestore), [ new En(t._key, _n.none()) ]);
>>>>>>> finishedGoodsRecipes
}
...
=======
 */ function Is(t, n) {
    const e = fe(t = Z(t, ae)), s = ps(t._converter, n), r = Re(Pe(t.firestore), "addDoc", e._key, s, null !== e._converter, {});
    return Hn(Xn(t.firestore), [ r.toMutation(e._key, _n.exists(!1)) ]).then((() => e));
>>>>>>> finishedGoodsRecipes
}
 ...
 */ class Ns {
    ...
    set(t, n, e) {
        this._verifyNotCommitted();
        const s = $s(t, this._firestore), r = ps(s._converter, n, e), i = Re(this._dataReader, "WriteBatch.set", s._key, r, null !== s._converter, e);
        return this._mutations.push(i.toMutation(s._key, _n.none())), this;
    }
    update(t, n, e, ...s) {
        this._verifyNotCommitted();
        const r = $s(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let i;
        return n instanceof oe && (n = n._delegate), i = "string" == typeof n || n instanceof pe ? qe(this._dataReader, "WriteBatch.update", r._key, n, e, s) : xe(this._dataReader, "WriteBatch.update", r._key, n), 
        this._mutations.push(i.toMutation(r._key, _n.exists(!0))), this;
>>>>>>> finishedGoodsRecipes
    }
    /**
...
=======
        const n = $s(t, this._firestore);
        return this._mutations = this._mutations.concat(new En(n._key, _n.none())), this;
>>>>>>> finishedGoodsRecipes
    }
    /**
...
function $s(t, n) {
    if (t instanceof oe && (t = t._delegate), t.firestore !== n) throw new q(v, "Provided document reference is from a different Firestore instance.");
>>>>>>> finishedGoodsRecipes
    return t;
}
...
=======
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new q(v, "Firestore transactions require all reads to be executed before all writes.");
        const n = await Kn(this.datastore, t);
        return n.forEach((t => {
            t instanceof Ot || t instanceof qt ? this.recordVersion(t) : m();
        })), n;
>>>>>>> finishedGoodsRecipes
    }
    set(t, n) {
...
=======
        this.write(new En(t, this.precondition(t))), this.writtenDocs.add(t.toString());
>>>>>>> finishedGoodsRecipes
    }
    async commit() {
...
<<<<<<< HEAD
        if (t.isFoundDocument()) n = t.version; else {
            ...
            n = mt.min();
=======
        if (t instanceof qt) n = t.version; else {
            if (!(t instanceof Ot)) throw m();
            // For deleted docs, we must use baseVersion 0 when we overwrite them.
            n = un.min();
>>>>>>> finishedGoodsRecipes
        }
...
=======
        return !this.writtenDocs.has(t.toString()) && n ? _n.updateTime(n) : _n.none();
>>>>>>> finishedGoodsRecipes
    }
    /**
...
=======
            throw new q(v, "Can't update a document that doesn't exist.");
>>>>>>> finishedGoodsRecipes
...
class Ss {
    constructor(t, n, e, s) {
        ...
        this.Nt = 5, this.$t = new Gn(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    /** Runs the transaction and sets the result on deferred. */    run() {
        this.Dt();
    }
    Dt() {
        this.$t.X((async () => {
            const t = new Fs(this.datastore), n = this.Ft(t);
>>>>>>> finishedGoodsRecipes
            n && n.then((n => {
...
=======
     */    static createAndSchedule(t, n, e, s, r) {
        const i = Date.now() + e, o = new qs(t, n, i, s, r);
>>>>>>> finishedGoodsRecipes
        return o.start(e), o;
    }
    /**
...
=======
        ...
        this.Mt = [], 
        // Backoff timer used to schedule retries for retryable operations
        this.$t = new Gn(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Bt = () => {
            const t = xs();
            t && l("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.$t.nt();
        };
        const t = xs();
...
<<<<<<< HEAD
    ...
    enqueue(t) {
        return this.Ut(), this.St ? new Promise((t => {})) : this.jt(t);
    }
    enqueueRetryable(t) {
...
=======
    ...
    enqueueAfterDelay(t, n, e) {
        ...
        const s = qs.createAndSchedule(this, t, n, e, (t => this.zt(t)));
...
=======
        const n = $s(t, this._firestore), e = new ys(this._firestore);
        return this._transaction.lookup([ n._key ]).then((t => {
            if (!t || 1 !== t.length) return m();
            const s = t[0];
            if (s instanceof Ot) return new ze(this._firestore, e, n._key, null, n._converter);
            if (s instanceof qt) return new ze(this._firestore, e, s.key, s, n._converter);
            throw m();
        }));
    }
    set(t, n, e) {
        const s = $s(t, this._firestore), r = ps(s._converter, n, e), i = Re(this._dataReader, "Transaction.set", s._key, r, null !== s._converter, e);
    ...
    update(t, n, e, ...s) {
        ...
        // performing validation.
                let i;
        return n instanceof oe && (n = n._delegate), i = "string" == typeof n || n instanceof pe ? qe(this._dataReader, "Transaction.update", r._key, n, e, s) : xe(this._dataReader, "Transaction.update", r._key, n), 
...
=======
 */ function Ls(t, n) {
    const e = Xn(t = Z(t, ne)), s = new ut;
    return new Ss(new Os, e, (e => n(new Cs(t, e))), s).run(), s.promise;
>>>>>>> finishedGoodsRecipes
}
...
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "2.2.3", "node");
...
=======
 */ e(new r("firestore/lite", ((t, {options: n}) => {
    const e = t.getProvider("app-exp").getImmediate(), s = new ne(e, t.getProvider("auth-internal"));
    return n && s._setSettings(n), s;
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "2.2.1", "node");

export { me as Bytes, ae as CollectionReference, ue as DocumentReference, ze as DocumentSnapshot, pe as FieldPath, _e as FieldValue, ne as FirebaseFirestore, q as FirestoreError, ge as GeoPoint, ce as Query, Je as QueryConstraint, Ge as QueryDocumentSnapshot, Ye as QuerySnapshot, bt as Timestamp, Cs as Transaction, Ns as WriteBatch, Is as addDoc, Rs as arrayRemove, Ps as arrayUnion, he as collection, le as collectionGroup, Es as deleteDoc, Ts as deleteField, fe as doc, ye as documentId, ls as endAt, hs as endBefore, _s as getDoc, gs as getDocs, se as getFirestore, Vs as increment, ee as initializeFirestore, rs as limit, is as limitToLast, es as orderBy, Ze as query, we as queryEqual, de as refEqual, Ls as runTransaction, As as serverTimestamp, bs as setDoc, h as setLogLevel, He as snapshotEqual, cs as startAfter, us as startAt, ie as terminate, vs as updateDoc, re as useFirestoreEmulator, ts as where, Ds as writeBatch };
>>>>>>> finishedGoodsRecipes
